...
$crm = new Crm("kennethb@thehangar.onmicrosoft.com","kennethA20869","http://thehangar.crm.dynamics.com/Server/XRMServices/2011/OrganizationData.svc/pcl_ContactSet/(guid'76c14e55-7641-4f1c-8777-e73ef0418cd1')");
$data = $crm->buildJSON($array);
$crm->RetrieveData("http://localhost/php/crm.php");
